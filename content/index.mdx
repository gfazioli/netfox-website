...
<Callout type="info">
**New here?** [Download the latest release](https://github.com/gfazioli/netfox-website/releases/latest) and follow the [Getting Started](/docs/getting-started) walkthrough — you'll see your whole network inside a minute.
</Callout>
