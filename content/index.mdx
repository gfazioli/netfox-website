...
- [**Optimization**](/docs/tools/optimization) — placeholder for the post-0.3 module wave (Wi-Fi diagnostics → Link diagnostics → Bandwidth monitor)
...
- **Security checks** — TCP port probes against the well-known home-security set (SSH, Telnet, RDP, VNC, SMB, HTTP/HTTPS, MQTT, MySQL/PostgreSQL/Redis/MongoDB, common dev servers, …). Open services get a plain-English Risk Inspector with what each finding means and what to do about it
