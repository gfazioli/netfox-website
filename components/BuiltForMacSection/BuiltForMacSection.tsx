  ...
  return (
    <Box pos="relative" py={80} style={{ overflow: 'hidden' }}>
      {/*
        ...
        land. Colors stay in the Netfox orange/yellow brand family.
      */}
      <Scene lazy>
        <Scene.Mesh
          stops={[
            { color: 'orange', position: '15% 25%', spread: 60 },
            { color: 'yellow', position: '85% 70%', spread: 60 },
            { color: 'red', position: '50% 55%', spread: 75 },
          ]}
          opacity={0.18}
        />
